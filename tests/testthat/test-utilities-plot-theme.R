test_that("protigy_plot_theme encodes the typography contract", {
  th <- protigy_plot_theme()
...
test_that("protigy_plot_theme(gridlines = TRUE) keeps gridlines", {
  th <- protigy_plot_theme(gridlines = TRUE)
...
test_that("protigy_plot_theme composes onto a plot without error", {
