...
# NOTE: pelsa_section_head(), pelsa_setup_box_ui() (the per-dataset Setup box
# UI + its private per-layer builders), and pelsa_setup_ids() moved to
# tab_pelsa_section1_helpers_setup_box_ui.R (kept file/function sizes within
# the repo's guidelines; see that file's header comment).
