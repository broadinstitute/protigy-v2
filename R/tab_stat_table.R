...
# Module: Stat_Table
#
# Allow users to see the results of their chosen test as a table
################################################################################
...
# UI for the statTable tab
# contains the structure for the big tabbed box with omes
statTable_Tab_UI <- function(id = "statTableTab") {
...
# server for the statTable tab
# contains the structure for the big tabbed box with omes
statTable_Tab_Server <- function(id = "statTableTab",
                                         GCTs_and_params, 
                                         globals, 
                                         GCTs_original) { 
    ...
    output$ome_tabset_box <- renderUI({
      ...
      tabs <- lapply(all_omes(), function(ome){
        tabPanel(
          ...
          statTable_Ome_UI(id = ns(ome), ome = ome)
...
statTable_Ome_UI <- function (id, ome) {
...
statTable_Ome_Server <- function(id,
                                         ome,
                                         GCT_processed,
                                         parameters,
                                         GCT_original,
