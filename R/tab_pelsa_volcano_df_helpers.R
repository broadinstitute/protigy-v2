...
#
# This file carries ONLY the Task-3A data-frame builder (this comment block)
# and its private helpers. The background-thinning (3B) and Pass-2 (7D-7F)
# contrast-key / label-mode / color-mode selection helpers that used to live
# in this same file have been split out (this file had grown past the repo's
# 800-line cap) into sibling files:
#   R/tab_pelsa_volcano_helpers.R             - thinning + selection helpers
